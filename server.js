...
const INITIAL_USERS = [
  { id: 'usr-1', username: 'seftyan', name: 'Seftyan Indriyanto', email: 'seftyan@kipina.sch.id', role: 'Super Admin', branch: 'Head Office (GS)', phone: '0812-1122-3344', modules: ['noc_overview', 'noc_interfaces', 'noc_tunnel', 'noc_hotspot', 'noc_firewall', 'noc_tools', 'noc_reports', 'cctv_live', 'tickets_chat', 'admin_branch', 'admin_users', 'winbox_connect'], lastLogin: 'Aktif Sekarang', lastIp: '103.138.46.106', status: 'Active', password: 'admin123' },
  { id: 'usr-2', username: 'dimas_noc', name: 'Dimas Kurniawan', email: 'dimas.k@kipina.sch.id', role: 'Network Engineer', branch: 'Head Office (GS)', phone: '0812-9988-7711', modules: ['noc_overview', 'noc_interfaces', 'noc_tunnel', 'noc_hotspot', 'noc_firewall', 'noc_tools', 'noc_reports', 'winbox_connect', 'tickets_chat'], lastLogin: '12 menit lalu', lastIp: '10.255.255.10', status: 'Active', password: 'admin123' },
